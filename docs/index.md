...
!!! note "Documentation status"
    ...
    This site documents schema v11 and the shift, route, earnings, metrics, detail, delivery
    lifecycle, pickup identity, pickup wait, per-delivery earnings, expected pay, period summary,
    period comparison, history export, recorded expense, shift pause and Live Activity work
    completed so far. Every amount, coordinate, route, note and business name in it is synthetic.
