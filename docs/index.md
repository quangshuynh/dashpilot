...
!!! note "Documentation status"
    ...
    This site documents schema v12 and the shift, route, earnings, metrics, detail, delivery
    lifecycle, offer grouping, pickup identity, pickup wait, per-delivery earnings, expected pay,
    period summary, period comparison, history export, recorded expense, shift pause and Live
    Activity work completed so far. Every amount, coordinate, route, note and business name in it is synthetic.
